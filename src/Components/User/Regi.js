      ...
      <>
        ...
        <section id="banner" className="banner-section">
          <div className="container">
            <strong>
              {" "}
              Got a Show, Event, Activity, Party , Corporate Meet or a Great
              Experience ?{" "}
            </strong>
            <p>
              {" "}
              ...
              Partner with us & get listed on <strong> eveManager</strong>
            </p>
            <form onSubmit={this.handleSubmit.bind(this)}>
              <div className="row">
                <div className="col-6">
                  ...
                  <label>
                    {" "}
                    <i className="fas fa-user"></i> Register as a
                  </label>
                  ...
                  {/* <div className="row">
                    <div className="col-6">
                      <select name="usertype" className="form-control">
                        ...
                        <option value="2">Both Visitor as well as Host </option>
                      </select>
                    </div>
                  </div> */}
                ...
                <div className="col-6">
                  ...
                  >
                    ...
                    <p style={{ color: "#000", paddingLeft: "200px" }}>
                      {" "}
                      Discover how to <strong>eve</strong>Manager, manage &
                      reduce prices, and more.
                      <br />
